<center><h2>Seleccione una opción de la izquierda para continuar</h2></center>
                ...
                <div class="box-content no-padding">
                  ...
                  <div class="tab-content">
                      ...
                      <ul class="users-list">
                        <li>
                          <a href="index.html#">
                            <img class="avatar" alt="Lucas" src="/sadmin/style/img/avatar.jpg">
                          </a>
                        ...
                        <li>
                          <a href="index.html#">
                            <img class="avatar" alt="Bill" src="/sadmin/style/img/avatar9.jpg">
                          </a>
                        ...
                        <li>
                          <a href="index.html#">
                            <img class="avatar" alt="Jane" src="/sadmin/style/img/avatar5.jpg">
                          </a>
                        ...
                        <li>
                          <a href="index.html#">
                            <img class="avatar" alt="Kate" src="/sadmin/style/img/avatar6.jpg">
                          </a>
                        ...
                        <li>
                          <a href="index.html#">
                            <img class="avatar" alt="Lucas" src="/sadmin/style/img/avatar7.jpg">
                          </a>
          ...
          <div class="row">
            ...
            <div class="col-lg-12 discussions">
              ...
              <ul>
                ...
                <li>
                  <div class="author">
                    <img src="/sadmin/style/img/avatar.jpg" alt="avatar">
                  </div>
                  ...
                  <ul>
                    ...
                    <li>
                      <div class="author">
                        <img src="/sadmin/style/img/avatar3.jpg" alt="avatar">
                      </div>
                    ...
                    <li>
                      <div class="author">
                        <img src="/sadmin/style/img/avatar6.jpg" alt="avatar">
                      </div>
                ...
                <li>
                  ...
                  <div class="message row">
                    <div class="col-sm-3 col-xs-6">
                      <img src="/sadmin/style/img/gallery/photo2.jpg" class="img-responsive img-thumbnail">
                    </div>
                    <div class="col-sm-3 col-xs-6">
                      <img src="/sadmin/style/img/gallery/photo3.jpg" class="img-responsive img-thumbnail">
                    </div>
                    <div class="col-sm-3 col-xs-6">
                      <img src="/sadmin/style/img/gallery/photo4.jpg" class="img-responsive img-thumbnail">
                    </div>
                    <div class="col-sm-3 col-xs-6">
                      <img src="/sadmin/style/img/gallery/photo5.jpg" class="img-responsive img-thumbnail">
                    </div>  
                  </div>  
                ...
                <li>
                  <div class="author">
                    <img src="/sadmin/style/img/avatar9.jpg" alt="avatar">
                  </div>
                  ...
                  <ul>
                    ...
                    <li>
                      <div class="author">
                        <img src="/sadmin/style/img/avatar2.jpg" alt="avatar">
                      </div>
                    ...
                    <li>
                      <div class="author">
                        <img src="/sadmin/style/img/avatar4.jpg" alt="avatar">
                      </div>
