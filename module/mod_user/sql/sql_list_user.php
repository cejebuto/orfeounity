...
//Si existe la conexión, procedemos a validar. /style/img/loading.gif
}else{
    ...
    // $Page_url_order = "/$name_proyect/".$_GET['url_module']."/sgd/".$_GET['option']."/lst/".$_GET['page']."/".$_GET['size']."/". $_GET['order']."/".$_GET['by'];
